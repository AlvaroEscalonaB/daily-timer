...
export const useMeetingStore = create<MeetingState>()((set, get) => ({
	...
	next: () => {
		...
		set({ currentIndex: nextIndex, secondsLeft: durationSeconds, timerStatus: 'idle', _intervalId: null })
	},
	...
	back: () => {
		...
		clearTimer(_intervalId)
		set({ currentIndex: currentIndex - 1, secondsLeft: durationSeconds, timerStatus: 'idle', _intervalId: null })
	},
	...
	setDurationSeconds: (seconds) => {
		clearTimer(get()._intervalId)
		set({ durationSeconds: seconds, secondsLeft: seconds, timerStatus: 'idle', _intervalId: null, currentIndex: 0 })
	},
}))
